...
async function inputSN(allSNs, nf, equipament){
    ...
    for (let row of items.rows) {
        ...
        //Enviar uma mensagem unica para o meu popup.js e avisar realizar o for insiserindo o SN na variavel  params
